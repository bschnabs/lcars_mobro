...
_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee2() {
  var cpuTempBars, cpuTempVal, cpuLoadBars, cpuLoadVal, gpuTempBar, gpuLoadBar, data, cpuBars, x, staticTemp;
    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          ...
          cpuLoadBars = document.querySelectorAll('div[id*="cpuLoad"]');
          cpuLoadVal = document.getElementById('cpuLdVal');
          /*GPU VARIABLES*/

          gpuTempBar = document.getElementById('gpuTempBar');
          gpuLoadBar = document.getElementById('gpuLoadBar');
          _context2.next = 8;
          return MobroSDK.init().then( /*#__PURE__*/_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee() {
            var ramAvail, ramUsed, totalRam, ramUsageGraph;
              ...
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    ...
                    MobroSDK.addChannelListener('general_processor_usage', function (data) {
                    ...
                    MobroSDK.addChannelListener('general_graphics_temperature', function (data) {
                    ...
                    MobroSDK.addChannelListener('general_graphics_usage', function (data) {
                    ...
                    _context.next = 6;
                    return MobroSDK.emit("monitor:sensor:data", "general_memory_available");

                  case 6:
                    ramAvail = _context.sent;
                    _context.next = 9;
                    return MobroSDK.emit("monitor:sensor:data", "general_memory_used");

                  case 9:
                    ramUsed = _context.sent;
                    totalRam = +ramUsed.value + +ramAvail.value;
                    ramUsageGraph = document.querySelectorAll('path[id*="ramArray"]');
                    /*RAM*/

                    MobroSDK.addChannelListener('general_memory_used', function (data) {
...
// Module
___CSS_LOADER_EXPORT___.push([module.i, "html, body {\r\n   background-color: black;\r\n}\r\n\r\n.lcarsFade {\r\n   animation: fadeinout 3s infinite;\r\n}\r\n\r\n@keyframes fadeinout {\r\n 0% { opacity: 0; }\r\n 50% { opacity: 1; }\r\n 100% { opacity: 0;}\r\n}", "",{"version":3,"sources":["webpack://app/app.css"],"names":[],"mappings":"AAAA;GACG,uBAAuB;AAC1B;;AAEA;GACG,gCAAgC;AACnC;;AAEA;CACC,KAAK,UAAU,EAAE;CACjB,MAAM,UAAU,EAAE;CAClB,OAAO,UAAU,CAAC;AACnB","sourcesContent":["html, body {\r\n   background-color: black;\r\n}\r\n\r\n.lcarsFade {\r\n   animation: fadeinout 3s infinite;\r\n}\r\n\r\n@keyframes fadeinout {\r\n 0% { opacity: 0; }\r\n 50% { opacity: 1; }\r\n 100% { opacity: 0;}\r\n}"],"sourceRoot":""}]);
// Exports
